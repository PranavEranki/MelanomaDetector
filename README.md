...
6. If you want to test your model, run the testModel.py file
   - If you want to test out a new model, delete the models folder, change the fullVGG.py file as needed, then rerun(in order) the topVGG.py file, the fullVGG.py, then the testModel.py file. Also delete the rocCurve.png file which is generated by the testModel.py file.
