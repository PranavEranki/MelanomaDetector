...
6. If you want to test your model, run the testModel.py file
   - If you want to test out a new model, delete the models folder, change the fullVGG.py file as needed, then rerun both the fullVGG.py and testModel.py files. Also delete the rocCurve.png file which is generated by the testModel.py file.
